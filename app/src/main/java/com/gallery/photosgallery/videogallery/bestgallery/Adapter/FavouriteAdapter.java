...
import static com.gallery.photosgallery.videogallery.bestgallery.Activity.MainActivity.mEmpty;
import static com.gallery.photosgallery.videogallery.bestgallery.Activity.MainActivity.mFolderRec;
        ...
        holder.mImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (file.getName().toLowerCase().endsWith(".jpg") || file.getName().toLowerCase().endsWith(".jpeg") || file.getName().toLowerCase().endsWith(".png")) {
                    ...
                    in = new Intent(activity, ViewImageActivity.class);
                } else {
                    ViewVideoActivity slideShowActivity = new ViewVideoActivity();
                    slideShowActivity.SetList(objects, position);
                    in = new Intent(activity, ViewVideoActivity.class);
                    in.putExtra("From1", "FavsVideo");
                }
