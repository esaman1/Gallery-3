...
import static com.gallery.photosgallery.videogallery.bestgallery.Activity.ViewImageActivity.mOptionRL;
import static com.gallery.photosgallery.videogallery.bestgallery.Activity.ViewImageActivity.mRotateRL;
...
//        mImage = (GestureImageView) viewLayout.findViewById(R.id.mImage);
        mImage = viewLayout.findViewById(R.id.mImage);
    ...
    public void DeleteAction(int position,String from){
        ...
        if(from.equals("Album")) {
            ...
            long mediaID=Utils.getFilePathToMediaID(file.getAbsolutePath(),  _activity.getBaseContext());
            ...
            if (isDelete) {
                ...
                Toasty.success(_activity, "Image Successfully deleted!!!", Toast.LENGTH_SHORT).show();
            } else {
